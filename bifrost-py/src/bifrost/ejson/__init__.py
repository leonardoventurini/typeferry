...
from bifrost.ejson import custom_types
from bifrost.ejson.base64 import decode_base64, encode_base64
from bifrost.ejson.converters import EJSONRegExp, builtin_converters
from bifrost.ejson.custom_types import CustomType
from bifrost.ejson.equals import equals
...
def add_type(name: str, factory: Callable[[Any], Any]) -> None:
    """Register a custom-type factory (see :mod:`bifrost.ejson.custom_types`)."""
