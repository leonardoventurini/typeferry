...
- Local development and builds use the package-owned TypeFerry commands.
  Keep Vite, Vitest, proxy, and process-orchestration configuration out of the
  application unless the framework architecture changes.
