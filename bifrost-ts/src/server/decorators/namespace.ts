/**
 * @Namespace class decorator — registers a class as a Bifrost RPC namespace.
 *
 ...
 *
 * @module bifrost/server/decorators/namespace
 */
...
/**
 * Registers the decorated class as a Bifrost namespace with the given prefix.
 *
