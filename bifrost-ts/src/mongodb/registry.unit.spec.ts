...
import { BifrostMongoRegistry, mongoCollectionClass } from './registry'
...
describe('BifrostMongoRegistry', () => {
  ...
  it('returns native collections and metadata for registered tokens', () => {
    ...
    const registry = new BifrostMongoRegistry(
  ...
  it('closes owned clients but leaves external clients open by default', async () => {
    ...
    const owned = new BifrostMongoRegistry(
      { db, collections: [BoardsCollection] },
    ...
    const external = new BifrostMongoRegistry(
      { db, collections: [BoardsCollection] },
    ...
    const explicitlyClosed = new BifrostMongoRegistry(
