/**
 * Browser-safe event emitter used across Bifrost runtime paths.
 *
 ...
 * semantics Bifrost relies on to avoid subscription leaks.
 */
...
export default class EventEmitter2 {
  ...
  private warnMaxListeners(event: string): void {
    ...
    console.warn(`[Bifrost] Listener count exceeded for "${event}"`)
  }
