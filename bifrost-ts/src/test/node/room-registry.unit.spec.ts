...
import type { BifrostSocket } from '../../server/types'

/** Creates a mock BifrostSocket with configurable readyState. */
function createMockSocket(
  readyState = 1 /* OPEN */,
): BifrostSocket & { sentMessages: string[] } {
  const sent: string[] = []
  ...
  } as unknown as BifrostSocket & { sentMessages: string[] }
}
