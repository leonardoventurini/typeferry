"""Protocol constants — verbatim port of ``typeferry-ts/src/utils/constants.ts``.
...
TYPEFERRY_WS_PATH = "/typeferry-ws"
...
class TypeFerryEvents(StrEnum):
    METHOD_REFRESH = "typeferry:method:refresh"
