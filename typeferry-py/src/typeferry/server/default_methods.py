...
Mirrors ``typeferry-ts/src/server/methods.ts`` and
``typeferry-ts/src/server/default-methods.ts``:
...
from typeferry.protocol.constants import NO_CHANNEL, Methods, ServerEvents
