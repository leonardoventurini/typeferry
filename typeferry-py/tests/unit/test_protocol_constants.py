...
from typeferry.protocol import (
...
def test_endpoint_paths() -> None:
    ...
    assert TYPEFERRY_WS_PATH == "/typeferry-ws"
...
def test_typeferry_events_values() -> None:
    assert TypeFerryEvents.METHOD_REFRESH.value == "typeferry:method:refresh"
    assert (
        TypeFerryEvents.COMMIT_PENDING_SUBSCRIPTIONS.value
