...
describe('Typed Events', () => {
  ...
  describe('typeferry:event', () => {
    it('should receive event via typed event', async () => {
      ...
      clientNode!.emitTypeFerryEvent('typed:test-event', undefined, {
        message: 'hello',
      })
    ...
    it('should receive channel event via typed event', async () => {
      ...
      clientNode!.emitTypeFerryEvent('typed:channel-event', channelName, {
        data: 123,
      })
