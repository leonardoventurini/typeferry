/**
 * Unit tests for the TypeFerry decorator API.
 *
...
describe('TypeFerry Decorators', () => {
  ...
  describe('registerNamespace', () => {
    ...
    beforeEach(() => {
      addMethodSpy = vi.fn()
      global.TypeFerry = { addMethod: addMethodSpy } as never
    })

    afterEach(() => {
      delete (global as Record<string, unknown>).TypeFerry
    })
  ...
  describe('InferNamespace', () => {
    ...
    it('should exclude non-typeferry methods', () => {
      class TestMethods {
        async get(
          _client: ClientNode,
          _params: { id: string },
