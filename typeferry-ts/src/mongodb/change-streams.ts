...
export interface StartMongoWatchOptions<TDocument extends Document> {
  ...
  /** TypeFerry server used for event registration and emission. */
  readonly server: Server
  /** Delay before reconnecting after a transient stream failure. */
  readonly reconnectDelayMs?: number
}

/** Starts a native MongoDB change stream and emits matching changes through TypeFerry. */
...
/** Converts a change stream document into the public TypeFerry watch payload. */
