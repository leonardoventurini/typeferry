...
export async function createMongoIntegrationHarness(
  ...
  const uri = process.env.TYPEFERRY_MONGODB_TEST_URI ?? DEFAULT_MONGODB_TEST_URI
  const dbName =
...
/** Refuses destructive test cleanup outside the TypeFerry MongoDB test namespace. */
