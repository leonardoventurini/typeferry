...
export type TypeFerryLocalEventControllerOptions = {
  event?: string | null
  channel?: string
  active?: boolean
...
export class TypeFerryLocalEventController extends TypeFerryClientBoundController {
  ...
  constructor(
    ...
    options: TypeFerryLocalEventControllerOptions,
  ) {
    super(host, client)
  ...
  setOptions(options: TypeFerryLocalEventControllerOptions): void {
