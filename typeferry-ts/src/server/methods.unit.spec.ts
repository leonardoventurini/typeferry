...
describe('rpcOff', () => {
  ...
  it('returns false for unknown events', async () => {
    ...
    expect(logSpy).toHaveBeenCalledWith('[TypeFerry] Event Not Found:', 'unknown')
    logSpy.mockRestore()
  })
