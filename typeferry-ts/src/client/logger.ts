/**
 * Centralized logging for TypeFerry client.
...
/**
 * Logger for TypeFerry client with structured logging support.
 *
 * @example
 * ```ts
 * const logger = new TypeFerryLogger()
...
export class TypeFerryLogger {
  ...
  private output(entry: LogEntry): void {
    const prefix = `[TypeFerry:${entry.category}]`
...
/** Shared logger instance for the TypeFerry client. */
export const logger = new TypeFerryLogger()
