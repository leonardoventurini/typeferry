//! `TypeFerrySocket` trait — the minimal surface the runtime needs from
...
/// `impl TypeFerrySocket` that the runtime uses for broadcast, auth
/// result delivery, etc.
#[async_trait]
pub trait TypeFerrySocket: Send + Sync {
