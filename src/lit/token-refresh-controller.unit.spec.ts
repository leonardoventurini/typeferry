...
import { BifrostTokenRefreshController } from './token-refresh-controller'
...
describe('BifrostTokenRefreshController', () => {
  beforeEach(() => {
    vi.useFakeTimers()
  })
  ...
  it('starts token refresh only after authentication and clears on disconnect', async () => {
    ...
    const controller = new BifrostTokenRefreshController(host, client, {
